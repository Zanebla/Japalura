...
import { RGBIndex, HSVIndex, AngelRange } from '@bundle:com.example.imagetestharmony/entry/ets/viewmodel/OptionViewModel';
/**
 * Saturation adjust.
 *
 * @param pixelMap.
...
export function execColorInfo(bufferArray, last, cur, hsvIndex) {
    ...
    for (let i = 0; i < (colorInfo === null || colorInfo === void 0 ? void 0 : colorInfo.length); i += CommonConstants.PIXEL_STEP) {
...
//# sourceMappingURL=AdjustUtil.js.map