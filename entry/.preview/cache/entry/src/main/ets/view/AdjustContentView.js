...
export default class AdjustContentView extends ViewPU {
    ...
    TabBuilder(index, name, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("view/AdjustContentView.ets(14:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/AdjustContentView.ets(15:7)");
            Image.width({ "id": 16777250, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            Image.height({ "id": 16777249, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            if (!isInitialRender) {
                Image.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create(name);
            Text.debugLine("view/AdjustContentView.ets(19:7)");
            ...
            Text.margin({ top: { "id": 16777252, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" } });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Tabs.debugLine("view/AdjustContentView.ets(32:5)");
            Tabs.margin({ bottom: { "id": 16777251, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" } });
            Tabs.onChange((index) => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.TabBuilder.call(this, AdjustId.BRIGHTNESS, { "id": 16777230, "type": 10003, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                } });
            TabContent.debugLine("view/AdjustContentView.ets(33:7)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.TabBuilder.call(this, AdjustId.TRANSPARENCY, { "id": 16777242, "type": 10003, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                } });
            TabContent.debugLine("view/AdjustContentView.ets(43:7)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.TabBuilder.call(this, AdjustId.SATURATION, { "id": 16777239, "type": 10003, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                } });
            TabContent.debugLine("view/AdjustContentView.ets(53:7)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
...
class SliderCustom extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("view/AdjustContentView.ets(91:5)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/AdjustContentView.ets(92:7)");
            Text.fontColor(Color.White);
            Text.margin({ top: { "id": 16777261, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" } });
            Text.fontSize({ "id": 16777260, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/AdjustContentView.ets(96:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Slider.debugLine("view/AdjustContentView.ets(97:9)");
...
export class Dialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("view/AdjustContentView.ets(189:5)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            LoadingProgress.debugLine("view/AdjustContentView.ets(190:7)");
