...
class HomePage extends ViewPU {
    ...
    NavigationTitle(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("pages/HomePage.ets(20:5)");
            if (!isInitialRender) {
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777235, "type": 10003, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            Text.debugLine("pages/HomePage.ets(21:7)");
            Text.fontColor(Color.Red);
            Text.fontSize({ "id": 16777262, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
    ...
    TabBuilderMenu(index, name, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/HomePage.ets(28:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/HomePage.ets(29:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create(name);
            Text.debugLine("pages/HomePage.ets(34:7)");
            Text.fontColor(this.currentIndex === index ? Color.Blue : Color.White);
            Text.fontSize({ "id": 16777253, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            Text.margin({ top: { "id": 16777254, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" } });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
    ...
    TitleNavigation(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.debugLine("pages/HomePage.ets(150:5)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/HomePage.ets(151:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777280, "type": 20000, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            Image.debugLine("pages/HomePage.ets(152:9)");
            Image.width({ "id": 16777265, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            Image.height({ "id": 16777264, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            if (!isInitialRender) {
                Image.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Button.createWithChild();
            Button.debugLine("pages/HomePage.ets(164:7)");
            Button.height(CommonConstants.LAYOUT_FULL_SCREEN);
            Button.type(ButtonType.Normal);
            Button.aspectRatio(1);
            Button.backgroundColor(Color.Transparent);
            Button.onClick(() => {
                AlertDialog.show({
                    title: { "id": 16777241, "type": 10003, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" },
                    message: { "id": 16777232, "type": 10003, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" },
                    alignment: DialogAlignment.Center,
                    primaryButton: {
                        value: { "id": 16777240, "type": 10003, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" },
                        action: () => {
                            if (this.pixelMap) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777221, "type": 20000, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            Image.debugLine("pages/HomePage.ets(165:9)");
            Image.width({ "id": 16777265, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            Image.height({ "id": 16777264, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
            if (!isInitialRender) {
                Image.pop();
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Navigation.create();
            Navigation.debugLine("pages/HomePage.ets(198:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Stack.create();
            Stack.debugLine("pages/HomePage.ets(199:7)");
            if (!isInitialRender) {
                Stack.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/HomePage.ets(200:9)");
            Column.width(CommonConstants.LAYOUT_FULL_SCREEN);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/HomePage.ets(201:11)");
            Column.width(CommonConstants.LAYOUT_FULL_SCREEN);
            ...
            if (this.isPixelMapChange) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("pages/HomePage.ets(203:15)");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Image.create(this.pixelMap ? this.pixelMap : '');
                        Image.debugLine("pages/HomePage.ets(206:15)");
                        Image.objectFit(ImageFit.Contain);
                        if (!isInitialRender) {
                            Image.pop();
                        }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/HomePage.ets(213:11)");
            Column.width(CommonConstants.LAYOUT_FULL_SCREEN);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Tabs.debugLine("pages/HomePage.ets(214:13)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.create(() => {
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Row.create();
                    Row.debugLine("pages/HomePage.ets(216:17)");
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    const forEachItemGenFunction = (_item, index) => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ...
                            Image.debugLine("pages/HomePage.ets(218:21)");
                            Image.width({ "id": 16777256, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                            Image.height({ "id": 16777255, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                            Image.onClick(() => {
                                if (index) {
            ...
            TabContent.tabBar({ builder: () => {
                    this.TabBuilderMenu.call(this, MainTabId.CROP, { "id": 16777233, "type": 10003, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                } });
            TabContent.debugLine("pages/HomePage.ets(215:15)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.create(() => {
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Row.create();
                    Row.debugLine("pages/HomePage.ets(236:17)");
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Image.create({ "id": 16777246, "type": 20000, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                    Image.debugLine("pages/HomePage.ets(237:19)");
                    Image.width({ "id": 16777258, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                    Image.height({ "id": 16777257, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                    Image.create({ "id": 16777224, "type": 20000, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                    Image.debugLine("pages/HomePage.ets(244:19)");
                    Image.width({ "id": 16777258, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                    Image.height({ "id": 16777257, "type": 10002, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                    Image.onClick(async () => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.TabBuilderMenu.call(this, MainTabId.ROTATE, { "id": 16777238, "type": 10003, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                } });
            TabContent.debugLine("pages/HomePage.ets(235:15)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.TabBuilderMenu.call(this, MainTabId.ADJUST, { "id": 16777229, "type": 10003, params: [], "bundleName": "com.example.imagetestharmony", "moduleName": "entry" });
                } });
            TabContent.debugLine("pages/HomePage.ets(257:15)");
            if (!isInitialRender) {
                TabContent.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
